...
ajax_hooks['get_floors'] = {before:function(response,vars,form,objs){$("body").addClass("loading")},after:function(response,vars,form,objs){$(".container-floors").html(response.html);$("body").removeClass("loading");store_modal_link()}};
