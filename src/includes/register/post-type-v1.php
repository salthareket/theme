...
add_action('save_post', function($post_id, $post, $update) {
    ...
    if ($term_slug === 'custom') {
        ...
        // PAE inline CSS'i — PageAssetsExtractor'in topladi inline <style> icerikleri
        // PAE fetch sirasinda bunlari assets meta'sina kaydeder, biz de CSS dosyasina dahil ediyoruz
        ...
        // Eger PAE henuz calismadiysa, fetch body'den kalan style tag'larini da kontrol et
        // (fetch_body icindeki head style'lari — block CSS'leri disinda kalanlar)
        if (!empty($fetch_body)) {
            $head_css = '';
        ...
        // CSS minify — tekrarlayan kurallari temizle
