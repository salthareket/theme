 ...
 *
 * BASIC USAGE:
 * - Instance al : Theme_Styles_New::init()
 * - Data oku    : Theme_Styles_New::init()->get_data()
 * - Data kaydet : Theme_Styles_New::init()->save_data($data, 'preset-name')
 * - Modüller    : Theme_Styles_New::get_modules()
 *
 * @example Instance alma:
 * $ts = Theme_Styles_New::init();
 *
 ...
 * Theme_Styles_New::init()->save_data($data, 'my-preset');
 *
 * @example Data kaydetme (preset adı olmadan - default):
 * Theme_Styles_New::init()->save_data($data);
 *
...
class Theme_Styles_New {
    ...
    private function __construct() {
        ...
        // theme-styles-new.css frontend'e enqueue edilmiyor — root.css yeterli
    ...
    public function add_admin_menu() {
        add_submenu_page(
            'theme-settings',
            __('🎨 Tema Stilleri', 'theme-styles-new'),
            __('🎨 Tema Stilleri', 'theme-styles-new'),
            'manage_options',
            'theme-styles-new',
    ...
    public function render_admin_page() {
        include THEME_STYLES_NEW_PATH . '/admin/templates/main.php';
    }
    ...
    public function enqueue_admin_assets($hook) {
        if ($hook !== 'theme-settings_page_theme-styles-new') {
            return;
        }
        
        // CSS
        wp_enqueue_style(
            'theme-styles-new-admin',
            THEME_STYLES_NEW_URL . '/admin/assets/css/admin.css',
            [],
            THEME_STYLES_NEW_VERSION
        );
        
        // JS
        wp_enqueue_script(
            'theme-styles-new-admin',
            THEME_STYLES_NEW_URL . '/admin/assets/js/admin.js',
            ['jquery'],
            THEME_STYLES_NEW_VERSION,
            true
        );
        ...
        wp_localize_script('theme-styles-new-admin', 'themeStylesNew', [
            'ajaxUrl'     => admin_url('admin-ajax.php'),
            'nonce'       => wp_create_nonce('theme_styles_new_nonce'),
        ...
        wp_enqueue_script(
            'theme-styles-colors',
            THEME_STYLES_NEW_URL . '/modules/colors/colors.js',
            ['jquery', 'jquery-ui-sortable', 'wp-element', 'wp-components', 'theme-styles-new-admin'],
            THEME_STYLES_NEW_VERSION,
            true
        );
        ...
        wp_enqueue_style(
            ...
            THEME_STYLES_NEW_URL . '/modules/typography/typography.css',
            ['theme-styles-new-admin'],
            THEME_STYLES_NEW_VERSION
        );
        ...
        wp_enqueue_script(
            'theme-styles-typography',
            THEME_STYLES_NEW_URL . '/modules/typography/typography.js',
            ['jquery', 'theme-styles-new-admin'],
            THEME_STYLES_NEW_VERSION,
            true
        );
        ...
        wp_enqueue_script(
            'theme-styles-header',
            THEME_STYLES_NEW_URL . '/modules/header/header.js',
            ['jquery', 'theme-styles-new-admin'],
            THEME_STYLES_NEW_VERSION,
            true
        );
        ...
        wp_enqueue_style(
            ...
            THEME_STYLES_NEW_URL . '/modules/pagination/pagination.css',
            ['theme-styles-new-admin'],
            THEME_STYLES_NEW_VERSION
        );
        ...
        wp_enqueue_script(
            'theme-styles-pagination',
            THEME_STYLES_NEW_URL . '/modules/pagination/pagination.js',
            ['jquery', 'theme-styles-new-admin'],
            THEME_STYLES_NEW_VERSION,
            true
        );
        ...
        wp_enqueue_style(
            ...
            THEME_STYLES_NEW_URL . '/modules/breadcrumb/breadcrumb.css',
            ['theme-styles-new-admin'],
            THEME_STYLES_NEW_VERSION
        );
        ...
        wp_enqueue_script(
            'theme-styles-breadcrumb',
            THEME_STYLES_NEW_URL . '/modules/breadcrumb/breadcrumb.js',
            ['jquery', 'theme-styles-new-admin'],
            THEME_STYLES_NEW_VERSION,
            true
        );
        ...
        wp_enqueue_style(
            ...
            THEME_STYLES_NEW_URL . '/modules/buttons/buttons.css',
            ['theme-styles-new-admin'],
            THEME_STYLES_NEW_VERSION
        );
        ...
        wp_enqueue_script(
            'theme-styles-buttons',
            THEME_STYLES_NEW_URL . '/modules/buttons/buttons.js',
            ['jquery', 'jquery-ui-sortable', 'theme-styles-new-admin'],
            THEME_STYLES_NEW_VERSION,
            true
        );
        ...
        wp_enqueue_style(
            ...
            THEME_STYLES_NEW_URL . '/modules/background/background.css',
            ['theme-styles-new-admin'],
            THEME_STYLES_NEW_VERSION
        );
        ...
        wp_enqueue_script(
            'theme-styles-background',
            THEME_STYLES_NEW_URL . '/modules/background/background.js',
            ['jquery', 'wp-element', 'wp-components', 'theme-styles-new-admin'],
            THEME_STYLES_NEW_VERSION,
            true
        );
        ...
        wp_enqueue_script(
            'theme-styles-footer',
            THEME_STYLES_NEW_URL . '/modules/footer/footer.js',
            ['jquery', 'theme-styles-new-admin'],
            THEME_STYLES_NEW_VERSION,
            true
        );
        ...
        wp_enqueue_script(
            ...
            THEME_STYLES_NEW_URL . '/modules/offcanvas/offcanvas.js',
            ['jquery', 'theme-styles-new-admin'],
            THEME_STYLES_NEW_VERSION,
            true
        );
    ...
    public function enqueue_frontend_assets() {
        $css_file = get_template_directory() . '/theme/static/css/theme-styles-new.css';
        
        if (file_exists($css_file)) {
            wp_enqueue_style(
                'theme-styles-new',
                get_template_directory_uri() . '/theme/static/css/theme-styles-new.css',
                [],
                filemtime($css_file)
            );
        }
    ...
    public function get_data() {
        ...
        // Try cache first
        $cached = get_transient('theme_styles_new_cache');
        if ($cached !== false) {
            self::$data = $cached;
            return self::$data;
        }
        ...
        if (file_exists($json_file)) {
            ...
            if ($data) {
                self::$data = $data;
                set_transient('theme_styles_new_cache', $data, DAY_IN_SECONDS);
                return self::$data;
            }
        }
    ...
    public function save_data($data, $preset_name = '') {
        // Save to database
        update_option('theme_styles_new_data', $data);

        // Track active preset
        $active = $preset_name !== '' ? $preset_name : get_option('theme_styles_new_active_preset', '');
        update_option('theme_styles_new_active_preset', $active);
        ...
        // Save to JSON
        $json_dir = get_template_directory() . '/theme/static/data/theme-styles-new';
        if (!is_dir($json_dir)) {
        ...
        // Clear cache
        delete_transient('theme_styles_new_cache');
        self::$data = null;
        ...
        if (function_exists('theme_styles_new_save_colors')) {
            theme_styles_new_save_colors($data);
        }
