...
<div class="ts-module-background">
    ...
    <div class="ts-section ts-sticky-preview">
            ...
            <div class="ts-body-preview-inner" id="ts-body-preview-inner">
                ...
                <div style="margin-top: 8px;">
                    <button type="button" class="ts-repeater-add-btn" id="ts-backdrop-test-btn" style="font-size:12px; padding: 6px 14px;">
                        ...
                        <?php _e('Test Backdrop', 'theme-styles-new'); ?>
                    </button>
                </div>
            </div>
        </div>
        ...
        <div class="ts-body-preview-backdrop-overlay hidden" id="ts-backdrop-overlay">
            <div class="ts-body-preview-modal">
                <p><?php _e('This is a modal on backdrop', 'theme-styles-new'); ?></p>
    ...
    ═══════════════════════════════════════ -->
    <div class="ts-section">
        <h3 class="ts-section-title"><?php _e('Colors', 'theme-styles-new'); ?></h3>
        <div class="ts-states-grid">

            <!-- Text -->
            <div class="ts-state-box">
                <div class="ts-state-box-header"><h5 class="ts-state-box-title"><?php _e('Text', 'theme-styles-new'); ?></h5></div>
                <div class="ts-state-box-body">
                    <div class="ts-state-field">
                        <label class="ts-field-label"><?php _e('Default', 'theme-styles-new'); ?></label>
            ...
            <!-- Link -->
            <div class="ts-state-box">
                <div class="ts-state-box-header"><h5 class="ts-state-box-title"><?php _e('Link', 'theme-styles-new'); ?></h5></div>
                <div class="ts-state-box-body">
                    <div class="ts-state-field">
                        <label class="ts-field-label"><?php _e('Default', 'theme-styles-new'); ?></label>
                    ...
                    <div class="ts-state-field">
                        <label class="ts-field-label"><?php _e('Hover', 'theme-styles-new'); ?></label>
                    ...
                    <div class="ts-state-field">
                        <label class="ts-field-label"><?php _e('Visited', 'theme-styles-new'); ?></label>
            ...
            <!-- Backdrop -->
            <div class="ts-state-box">
                <div class="ts-state-box-header"><h5 class="ts-state-box-title"><?php _e('Backdrop', 'theme-styles-new'); ?></h5></div>
                <div class="ts-state-box-body">
                    <div class="ts-state-field">
                    ...
                    <div class="ts-state-field">
                        <label class="ts-field-label"><?php _e('Opacity', 'theme-styles-new'); ?></label>
    ...
    ═══════════════════════════════════════ -->
    <div class="ts-section">
        <h3 class="ts-section-title"><?php _e('Selection Styles', 'theme-styles-new'); ?></h3>
        <p class="ts-section-description"><?php _e('Styles applied when user selects text (::selection)', 'theme-styles-new'); ?></p>
        <div class="ts-field-row">
            <div>
                <label class="ts-field-label"><?php _e('Selection Background', 'theme-styles-new'); ?></label>
            ...
            <div>
                <label class="ts-field-label"><?php _e('Selection Text Color', 'theme-styles-new'); ?></label>
    ...
    ═══════════════════════════════════════ -->
    <div class="ts-section">
        <h3 class="ts-section-title"><?php _e('Scrollbar', 'theme-styles-new'); ?></h3>
        <div class="ts-field-row ts-field-row-4">
            ...
            <div>
                <label class="ts-field-label"><?php _e('Track Color', 'theme-styles-new'); ?></label>
            ...
            <div>
                <label class="ts-field-label"><?php _e('Thumb Color', 'theme-styles-new'); ?></label>
            ...
            <div>
                <label class="ts-field-label"><?php _e('Thumb Hover', 'theme-styles-new'); ?></label>
    ...
    ═══════════════════════════════════════ -->
    <div class="ts-section">
        <h3 class="ts-section-title"><?php _e('Focus Styles', 'theme-styles-new'); ?></h3>
        <div class="ts-field-row ts-field-row-3">
            <div>
                <label class="ts-field-label"><?php _e('Outline Color', 'theme-styles-new'); ?></label>
            ...
            <div>
                <label class="ts-field-label"><?php _e('Outline Width', 'theme-styles-new'); ?></label>
                <input type="text" class="ts-field-input" data-field="focus_width" value="<?php echo esc_attr($data['focus_width'] ?? '2px'); ?>" placeholder="2px" />
            </div>
            <div>
                <label class="ts-field-label"><?php _e('Outline Style', 'theme-styles-new'); ?></label>
    ...
    ═══════════════════════════════════════ -->
    <div class="ts-section">
        <h3 class="ts-section-title"><?php _e('Rendering & Behavior', 'theme-styles-new'); ?></h3>
        <div class="ts-field-row ts-field-row-3">
            <div>
                <label class="ts-field-label"><?php _e('Smooth Scroll', 'theme-styles-new'); ?></label>
            ...
            <div>
                <label class="ts-field-label"><?php _e('Font Smoothing', 'theme-styles-new'); ?></label>
            ...
            <div>
                <label class="ts-field-label"><?php _e('Text Rendering', 'theme-styles-new'); ?></label>
