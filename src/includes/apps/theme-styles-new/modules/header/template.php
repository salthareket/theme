...
<div class="ts-module-header">
    ...
    <div class="ts-section ts-sticky-preview" id="ts-header-preview-section">
        ...
        <div class="ts-header-preview-wrapper">
            ...
            <div class="ts-header-preview-controls">
                <button type="button" class="ts-btn-group-item active" id="ts-hp-default"><?php _e('Default', 'theme-styles-new'); ?></button>
                <button type="button" class="ts-btn-group-item" id="ts-hp-affix"><?php _e('Affix', 'theme-styles-new'); ?></button>
            </div>
            <!-- Fake header -->
    ...
    <!-- Header Background -->
        <div class="ts-section">
            ...
            <div class="ts-field-row ts-field-row-3" style="margin-bottom:24px;">
                <div>
                    <label class="ts-field-label"><?php _e('Dropshadow', 'theme-styles-new'); ?></label>
                    <?php theme_styles_render_switch('header.dropshadow', !empty($h['dropshadow'])); ?>
                </div>
                <div>
                    <label class="ts-field-label"><?php _e('Z-Index', 'theme-styles-new'); ?></label>
            ...
            <div class="ts-states-grid ts-states-stacked">
                ...
                <div class="ts-state-box">
                    ...
                    <div class="ts-state-box-body">
                        <div class="ts-state-field">
                            <label class="ts-field-label"><?php _e('Bg Color', 'theme-styles-new'); ?></label>
                ...
                <!-- Affix -->
                <div class="ts-state-box">
                    <div class="ts-state-box-header"><h5 class="ts-state-box-title"><?php _e('Affix', 'theme-styles-new'); ?></h5></div>
                    <div class="ts-state-box-body">
                        <div class="ts-state-field">
                            <label class="ts-field-label"><?php _e('Bg Color', 'theme-styles-new'); ?></label>
    ...
    <div class="ts-module-tab-content" data-module-tab-content="navbar">
        <div class="ts-section">
            <h3 class="ts-section-title"><?php _e('Navigation Container', 'theme-styles-new'); ?></h3>
            ...
            <div class="ts-states-grid ts-states-stacked">
                ...
                <div class="ts-state-box">
                    ...
                    <div class="ts-state-box-body">
                        ...
                        <div class="ts-state-field">
                            <label class="ts-field-label"><?php _e('Padding (per breakpoint)', 'theme-styles-new'); ?></label>
                            <div class="ts-responsive-grid" style="margin-top:8px;">
                                <?php foreach ($bps as $bp): ?>
                                <div class="ts-responsive-column">
                                    <div class="ts-responsive-label"><span class="ts-bp-badge ts-bp-badge-<?php echo $bp; ?>"><?php echo $bp; ?></span></div>
    ...
    <div class="ts-module-tab-content" data-module-tab-content="nav">
        <div class="ts-section">
            <h3 class="ts-section-title"><?php _e('Navigation', 'theme-styles-new'); ?></h3>
            <?php $nav_height_same = !empty($nav['height_header']); ?>
            <div class="ts-field-row ts-field-row-3" style="margin-bottom:20px;">
                <div>
                    <label class="ts-field-label"><?php _e('Width', 'theme-styles-new'); ?></label>
                    <input type="text" class="ts-field-input" data-field="nav.width" value="<?php echo esc_attr($nav['width'] ?? 'auto'); ?>" placeholder="auto" />
                </div>
                <div>
                    <label class="ts-field-label"><?php _e('Margin', 'theme-styles-new'); ?></label>
    ...
    <div class="ts-module-tab-content" data-module-tab-content="nav_item">
        <div class="ts-section">
            <h3 class="ts-section-title"><?php _e('Nav Item', 'theme-styles-new'); ?></h3>
            ...
            <div style="display:grid;grid-template-columns:2fr 1fr 1fr 1fr 1fr;gap:16px;margin-bottom:24px;">
                ...
                <div>
                    <label class="ts-field-label"><?php _e('Weight', 'theme-styles-new'); ?></label>
                ...
                <div>
                    <label class="ts-field-label"><?php _e('Weight Active', 'theme-styles-new'); ?></label>
                ...
                <div>
                    <label class="ts-field-label"><?php _e('Transform', 'theme-styles-new'); ?></label>
            ...
            <div style="margin-top:24px;">
                <label class="ts-field-label"><?php _e('Font Size (per breakpoint)', 'theme-styles-new'); ?></label>
                <div class="ts-responsive-grid" style="margin-top:8px;">
                    <?php foreach ($bps as $bp): ?>
                    <div class="ts-responsive-column">
                        <div class="ts-responsive-label"><span class="ts-bp-badge ts-bp-badge-<?php echo $bp; ?>"><?php echo $bp; ?></span></div>
    ...
    <div class="ts-module-tab-content" data-module-tab-content="dropdown">
        ...
        <!-- Arrow -->
        <div class="ts-section">
            <h3 class="ts-section-title"><?php _e('Arrow', 'theme-styles-new'); ?></h3>
            <div class="ts-field-row ts-field-row-3">
                <div>
                    <label class="ts-field-label"><?php _e('Use Arrow', 'theme-styles-new'); ?></label>
                ...
                <div class="ts-dropdown-arrow-fields" <?php echo !$arrow_active ? 'style="display:none;"' : ''; ?>>
                    <label class="ts-field-label"><?php _e('Top', 'theme-styles-new'); ?></label>
                    <input type="text" class="ts-field-input" data-field="dropdown.arrow.top" value="<?php echo esc_attr($arrow['top'] ?? '100%'); ?>" placeholder="100%" />
                </div>
                <div class="ts-dropdown-arrow-fields" <?php echo !$arrow_active ? 'style="display:none;"' : ''; ?>>
                    <label class="ts-field-label"><?php _e('Left', 'theme-styles-new'); ?></label>
        ...
        <!-- Dropdown -->
        <div class="ts-section">
            <h3 class="ts-section-title"><?php _e('Dropdown', 'theme-styles-new'); ?></h3>
        ...
        <!-- Dropdown Item -->
        <div class="ts-section">
            <h3 class="ts-section-title"><?php _e('Dropdown Item', 'theme-styles-new'); ?></h3>
    ...
    <div class="ts-module-tab-content" data-module-tab-content="logo">
        <div class="ts-section">
            <h3 class="ts-section-title"><?php _e('Logo', 'theme-styles-new'); ?></h3>
            <div class="ts-field-row ts-field-row-3" style="margin-bottom:20px;">
                <div>
    ...
    <div class="ts-module-tab-content" data-module-tab-content="themes">
        <div class="ts-section">
            <h3 class="ts-section-title"><?php _e('Header Themes', 'theme-styles-new'); ?></h3>
            <p class="ts-section-description"><?php _e('CSS class-based overrides. Each theme applies when the given class is on the body/header element (e.g. has-hero).', 'theme-styles-new'); ?></p>
                    ...
                    <div class="ts-repeater-item ts-header-theme-item" data-index="<?php echo $ti; ?>">
                        ...
                        <div class="ts-header-theme-fields">
                            ...
                            <div class="ts-field-row" style="margin-bottom:16px;">
                                <div>
                                    <label class="ts-field-label"><?php _e('CSS Class', 'theme-styles-new'); ?> <span style="color:red">*</span></label>
                            ...
                            <!-- Default state -->
                            <div class="ts-theme-state-label"><?php _e('Default', 'theme-styles-new'); ?></div>
                            ...
                            <!-- Affix state -->
                            <div class="ts-theme-state-label"><?php _e('Affix', 'theme-styles-new'); ?></div>
                            <div class="ts-field-row ts-field-row-4">
    ...
    <div class="ts-module-tab-content" data-module-tab-content="header_tools">
        <div class="ts-section">
            <h3 class="ts-section-title"><?php _e('Header Tools', 'theme-styles-new'); ?></h3>
        </div>
    ...
    <div class="ts-tab-content active" data-tab-content="ht_general">
        <div class="ts-section">
            <h3 class="ts-section-title"><?php _e('Header Tools - General', 'theme-styles-new'); ?></h3>
