...
<div class="ts-module-footer">
    ...
    <!-- Colors & Typography -->
    <div class="ts-section">
        <h3 class="ts-section-title"><?php _e('Colors & Typography', 'theme-styles-new'); ?></h3>
        <div class="ts-field-row ts-field-row-4">
            ...
            <div>
                <label class="ts-field-label"><?php _e('Link Color', 'theme-styles-new'); ?></label>
                <input type="text" class="ts-field-input ts-color-input" data-field="link_color" value="<?php echo esc_attr($data['link_color'] ?? '#adb5bd'); ?>" />
            </div>
            <div>
                <label class="ts-field-label"><?php _e('Link Hover', 'theme-styles-new'); ?></label>
    ...
    <!-- Size -->
    <div class="ts-section">
        <h3 class="ts-section-title"><?php _e('Size', 'theme-styles-new'); ?></h3>
