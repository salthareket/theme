    ...
    <div class="ts-forms-border-wrap">
        ...
        <label class="ts-forms-4side-toggle" style="display:flex;align-items:center;gap:6px;margin-top:8px;font-size:12px;color:var(--ts-gray-600);cursor:pointer;">
            <input type="checkbox" class="ts-forms-4side-cb" data-target="ts-forms-4side-<?php echo $prefix; ?>"
                   ...
                   <?php checked($is4side); ?> />
            <?php _e('Per side', 'theme-styles-new'); ?>
        </label>
        <!-- 4-side panel -->
...
<div class="ts-module-forms">
    ...
    <div class="ts-section ts-sticky-preview">
        ...
        <div id="ts-forms-preview-area" style="display:flex;gap:20px;flex-wrap:wrap;align-items:flex-start;padding:4px 0;">
            ...
            <div style="flex:1;min-width:180px;">
                <label class="ts-fp-label"><?php _e('Label', 'theme-styles-new'); ?></label>
                <input type="text" class="ts-fp-input ts-fp-focusable" placeholder="<?php esc_attr_e('Click to see focus state...', 'theme-styles-new'); ?>" />
            </div>

            <div style="flex:1;min-width:180px;">
                <label class="ts-fp-label"><?php _e('Select', 'theme-styles-new'); ?></label>
                <select class="ts-fp-input ts-fp-focusable">
                    <option><?php _e('Option 1', 'theme-styles-new'); ?></option>
                    <option><?php _e('Option 2', 'theme-styles-new'); ?></option>
                </select>
            </div>

            <div style="flex:1;min-width:180px;">
                <label class="ts-fp-label"><?php _e('Textarea', 'theme-styles-new'); ?></label>
                <textarea class="ts-fp-input ts-fp-focusable" rows="3" placeholder="<?php esc_attr_e('Textarea...', 'theme-styles-new'); ?>"></textarea>
            </div>
            ...
            <div style="flex:0 0 100%;display:flex;gap:24px;flex-wrap:wrap;align-items:center;margin-top:4px;">
                <label class="ts-fp-check-label"><input type="checkbox" class="ts-fp-check" checked /> <?php _e('Checkbox', 'theme-styles-new'); ?></label>
                <label class="ts-fp-check-label"><input type="radio" class="ts-fp-radio" name="ts_fp_radio" checked /> <?php _e('Radio 1', 'theme-styles-new'); ?></label>
                <label class="ts-fp-check-label"><input type="radio" class="ts-fp-radio" name="ts_fp_radio" /> <?php _e('Radio 2', 'theme-styles-new'); ?></label>
                <label class="ts-fp-switch-label">
                    <span class="ts-fp-switch-track"><span class="ts-fp-switch-thumb"></span></span>
                    <?php _e('Switch', 'theme-styles-new'); ?>
                </label>
            </div>
    ...
    <div class="ts-section">
        <h3 class="ts-section-title"><?php _e('Input / Select / Textarea', 'theme-styles-new'); ?></h3>

        <div class="ts-states-grid">

            <!-- Default -->
            <div class="ts-state-box">
                <div class="ts-state-box-header"><h5 class="ts-state-box-title"><?php _e('Default', 'theme-styles-new'); ?></h5></div>
                <div class="ts-state-box-body">
                    <div class="ts-state-field">
                        <label class="ts-field-label"><?php _e('Text Color', 'theme-styles-new'); ?></label>
            ...
            <!-- Focus -->
            <div class="ts-state-box">
                <div class="ts-state-box-header"><h5 class="ts-state-box-title"><?php _e('Focus', 'theme-styles-new'); ?></h5></div>
                <div class="ts-state-box-body">
                    <div class="ts-state-field">
                        <label class="ts-field-label"><?php _e('Text Color', 'theme-styles-new'); ?></label>
                    ...
                    <div class="ts-state-field">
                        <label class="ts-field-label"><?php _e('Box Shadow', 'theme-styles-new'); ?></label>
            ...
            <!-- Placeholder -->
            <div class="ts-state-box">
                <div class="ts-state-box-header"><h5 class="ts-state-box-title"><?php _e('Placeholder', 'theme-styles-new'); ?></h5></div>
                <div class="ts-state-box-body">
                    <div class="ts-state-field">
        ...
        <div style="margin-top:24px;">
            <div class="ts-field-row ts-field-row-3">
                ...
                <div>
                    <label class="ts-field-label"><?php _e('Text Transform', 'theme-styles-new'); ?></label>
    ...
    <!-- ── Label ─────────────────────────────────────────────── -->
    <div class="ts-section">
        <h3 class="ts-section-title"><?php _e('Label', 'theme-styles-new'); ?></h3>
        <div class="ts-field-row ts-field-row-3">
            <div>
                <label class="ts-field-label"><?php _e('Color', 'theme-styles-new'); ?></label>
    ...
    <!-- ── Sizes ─────────────────────────────────────────────── -->
    <div class="ts-section">
        <h3 class="ts-section-title"><?php _e('Sizes', 'theme-styles-new'); ?></h3>
        <div class="ts-states-grid">
    ...
    <div class="ts-section">
        <h3 class="ts-section-title"><?php _e('Checkbox / Radio / Switch', 'theme-styles-new'); ?></h3>
        <div class="ts-field-row ts-field-row-3">
            <div>
                <label class="ts-field-label"><?php _e('Accent Color (checked)', 'theme-styles-new'); ?></label>
            ...
            <div>
                <label class="ts-field-label"><?php _e('Border Color', 'theme-styles-new'); ?></label>
        ...
        <div class="ts-field-row ts-field-row-3" style="margin-top:16px;">
            <div>
                <label class="ts-field-label"><?php _e('Switch Track BG', 'theme-styles-new'); ?></label>
            ...
            <div>
                <label class="ts-field-label"><?php _e('Switch Track BG (checked)', 'theme-styles-new'); ?></label>
            ...
            <div>
                <label class="ts-field-label"><?php _e('Switch Thumb Color', 'theme-styles-new'); ?></label>
    ...
    <!-- ── Validation ────────────────────────────────────────── -->
    <div class="ts-section">
        <h3 class="ts-section-title"><?php _e('Validation', 'theme-styles-new'); ?></h3>
        <div class="ts-field-row ts-field-row-3">
            <div>
                <label class="ts-field-label"><?php _e('Valid Color', 'theme-styles-new'); ?></label>
            ...
            <div>
                <label class="ts-field-label"><?php _e('Invalid Color', 'theme-styles-new'); ?></label>
            ...
            <div>
                <label class="ts-field-label"><?php _e('Invalid Border Color', 'theme-styles-new'); ?></label>
        ...
        <div class="ts-field-row" style="margin-top:16px;">
            <div>
                <label class="ts-field-label"><?php _e('Invalid Background', 'theme-styles-new'); ?></label>
