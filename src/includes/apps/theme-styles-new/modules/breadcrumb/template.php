    ...
    <div class="ts-section">
        ...
        <div class="ts-states-grid">
            ...
            <div class="ts-state-box">
                ...
                <div class="ts-state-box-body">
                    ...
                    <div class="ts-state-field">
                        <label class="ts-field-label"><?php _e('Text Decoration', 'theme-styles-new'); ?></label>
        ...
        <div style="margin-top: 30px;">
            <div class="ts-field-row ts-field-row-4">
                <div>
                    <label class="ts-field-label"><?php _e('Separator Icon', 'theme-styles-new'); ?></label>
                ...
                <div>
                    <label class="ts-field-label"><?php _e('Separator Color', 'theme-styles-new'); ?></label>
                ...
                <div>
                    <label class="ts-field-label"><?php _e('Separator Size', 'theme-styles-new'); ?></label>
        ...
        <div style="margin-top: 20px;">
            <div class="ts-field-row">
                <div>
                    <label class="ts-field-label"><?php _e('Max Width (Truncation)', 'theme-styles-new'); ?></label>
                    <input type="text" class="ts-field-input" data-field="max_width" value="<?php echo esc_attr($data['max_width'] ?? '200px'); ?>" placeholder="200px" />
                    <small class="ts-field-description"><?php _e('Long items will be truncated with ellipsis (...)', 'theme-styles-new'); ?></small>
                </div>
                <div>
                    <label class="ts-field-label"><?php _e('Enable Truncation', 'theme-styles-new'); ?></label>
