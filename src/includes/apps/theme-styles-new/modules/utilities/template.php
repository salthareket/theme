...
<div class="ts-module-utilities">
    ...
    <div class="ts-module-tab-content active" data-module-tab-content="ut_scroll">
        <div class="ts-section">
            <h3 class="ts-section-title"><?php _e('Scroll to Top', 'theme-styles-new'); ?></h3>

            <!-- Active toggle -->
            <div class="ts-field-row" style="margin-bottom:24px;">
                <div>
                    <label class="ts-field-label"><?php _e('Active', 'theme-styles-new'); ?></label>
            ...
            <div id="ts-stt-settings" <?php echo !$active ? 'style="display:none;"' : ''; ?>>
                ...
                <div class="ts-field-row ts-field-row-4" style="margin-bottom:20px;">
                    <div>
                        <label class="ts-field-label"><?php _e('Horizontal Position', 'theme-styles-new'); ?></label>
                    ...
                    <div>
                        <label class="ts-field-label"><?php _e('Vertical Position', 'theme-styles-new'); ?></label>
                    ...
                    <div>
                        <label class="ts-field-label"><?php _e('Gap from Edge', 'theme-styles-new'); ?></label>
                        <input type="text" class="ts-field-input" data-field="scroll_to_top.gap" value="<?php echo esc_attr($stt['gap'] ?? '35px'); ?>" placeholder="35px" />
                    </div>
                    <div>
                        <label class="ts-field-label"><?php _e('Show', 'theme-styles-new'); ?></label>
                ...
                <div class="ts-field-row ts-field-row-3" style="margin-bottom:20px;">
                    <div>
                        <label class="ts-field-label"><?php _e('Icon (FA HTML)', 'theme-styles-new'); ?></label>
                    ...
                    <div>
                        <label class="ts-field-label"><?php _e('Animation Duration (ms)', 'theme-styles-new'); ?></label>
    ...
    <div class="ts-module-tab-content" data-module-tab-content="ut_hero">
        <div class="ts-section">
            <h3 class="ts-section-title"><?php _e('Hero Height', 'theme-styles-new'); ?></h3>
            <p class="ts-section-description"><?php _e('Set hero section height per breakpoint. Use units like vh, px, etc.', 'theme-styles-new'); ?></p>
