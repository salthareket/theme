...
// Define constants
define('THEME_STYLES_NEW_VERSION', '1.0.0');
define('THEME_STYLES_NEW_PATH', __DIR__);
define('THEME_STYLES_NEW_URL', get_template_directory_uri() . '/vendor/salthareket/theme/src/includes/apps/theme-styles-new');
