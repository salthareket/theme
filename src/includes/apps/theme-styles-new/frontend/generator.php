 ...
 *
 * HOW TO USE:
 * theme_styles_new_generate_root_css($data) → root.css yazar
 * theme_styles_new_save_colors($data)       → colors.json + _colors.scss yazar
 *
 * @example Save sonrası çağrım (save_data içinde):
 * theme_styles_new_generate_root_css($data);
 ...
 */
function theme_styles_new_save_colors(array $data): void {
    $colors = $data['colors'] ?? [];
