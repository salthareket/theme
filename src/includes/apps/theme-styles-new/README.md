...
include_once get_template_directory() . '/theme/includes/theme-styles-new/index.php';
```
...
return [
    'id' => 'my-module',
    'title' => __('My Module', 'theme-styles-new'),
    'description' => __('My custom module', 'theme-styles-new'),
...
<div class="ts-module-my-module">
    <div class="ts-field-group">
        <label class="ts-field-label"><?php _e('My Field', 'theme-styles-new'); ?></label>
...
do_action('theme_styles_new_before_save', $data);

// After styles are saved
do_action('theme_styles_new_after_save', $data);

// Before CSS generation
do_action('theme_styles_new_before_css_generation', $data);

// After CSS generation
do_action('theme_styles_new_after_css_generation', $css);
```
...
$data = apply_filters('theme_styles_new_save_data', $data);

// Modify generated CSS
$css = apply_filters('theme_styles_new_generated_css', $css, $data);

// Modify default data
$default = apply_filters('theme_styles_new_default_data', $default);
```
