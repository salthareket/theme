...
<div class="ts-module-colors">
    ...
    <div class="ts-section">
        <h3 class="ts-section-title"><?php _e('Primary Colors', 'theme-styles'); ?></h3>
        <div class="ts-colors-grid">
            <?php 
            $primary_colors = [
                'primary' => __('Primary', 'theme-styles'),
                'secondary' => __('Secondary', 'theme-styles'),
                'tertiary' => __('Tertiary', 'theme-styles'),
                'quaternary' => __('Quaternary', 'theme-styles')
            ];
            ...
            <div class="ts-color-field-pro">
                <div class="ts-color-field-header">
                    ...
                    <div class="ts-color-actions">
                        <button type="button" class="ts-color-action-btn ts-generate-shades" data-color-key="<?php echo $key; ?>" title="<?php esc_attr_e('Generate Shades', 'theme-styles'); ?>">
                            <span class="dashicons dashicons-admin-appearance"></span>
                        </button>
                        <button type="button" class="ts-color-action-btn ts-copy-var" data-var="--color-<?php echo $key; ?>" title="<?php esc_attr_e('Copy CSS Variable', 'theme-styles'); ?>">
    ...
    <div class="ts-section" id="ts-color-shades-section" style="display: none;">
        <h3 class="ts-section-title"><?php _e('Color Shades', 'theme-styles'); ?></h3>
        <p class="ts-section-description"><?php _e('Generated shades are for reference only and not saved. Click the palette icon next to any primary color to generate shades.', 'theme-styles'); ?></p>
        <div id="ts-color-shades-container"></div>
    </div>
    
    <!-- Custom Colors -->
    <div class="ts-section">
        <h3 class="ts-section-title"><?php _e('Custom Colors', 'theme-styles'); ?></h3>
        <div class="ts-repeater-container">
            <div class="ts-repeater-empty" id="ts-custom-colors-empty">
                ...
                <p class="ts-repeater-empty-text"><?php _e('No custom colors yet', 'theme-styles'); ?></p>
            </div>
                ...
                <div class="ts-repeater-item" data-index="<?php echo $index; ?>">
                    ...
                    <div class="ts-repeater-fields">
                        <div class="ts-color-field">
                            <label class="ts-field-label"><?php _e('Name', 'theme-styles'); ?></label>
                    ...
                    <button type="button" class="ts-repeater-remove" title="<?php esc_attr_e('Remove', 'theme-styles'); ?>">
    ...
    <!-- Custom Gradients -->
    <div class="ts-section">
        <h3 class="ts-section-title"><?php _e('Custom Gradients', 'theme-styles'); ?></h3>
        ...
        <div class="ts-repeater-container">
            <div class="ts-repeater-empty" id="ts-custom-gradients-empty">
                ...
                <p class="ts-repeater-empty-text"><?php _e('No custom gradients yet', 'theme-styles'); ?></p>
            </div>
                ...
                <div class="ts-repeater-item" data-index="<?php echo $index; ?>">
                    ...
                    <div class="ts-repeater-fields">
                        ...
                        <div class="ts-gradient-field ts-gradient-picker-wrapper">
                            <label class="ts-field-label"><?php _e('Gradient', 'theme-styles'); ?></label>
            ...
            <div class="ts-repeater-footer">
                <button type="button" class="ts-repeater-add-btn" id="ts-add-custom-gradient">
                    <span class="dashicons dashicons-plus-alt"></span>
                    <?php _e('Add Gradient', 'theme-styles'); ?>
                </button>
            </div>
        </div>
    </div>
