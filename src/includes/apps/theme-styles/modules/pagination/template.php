...
<div class="ts-module-pagination">
    ...
    <div class="ts-section">
        ...
        <div class="ts-field-row-compact">
            <div>
                <label class="ts-field-label"><?php _e('Alignment', 'theme-styles'); ?></label>
                <select class="ts-field-select ts-field-narrow" data-field="align">
                    <option value="left" <?php selected($data['align'] ?? 'center', 'left'); ?>><?php _e('Left', 'theme-styles'); ?></option>
                    <option value="center" <?php selected($data['align'] ?? 'center', 'center'); ?>><?php _e('Center', 'theme-styles'); ?></option>
                    <option value="right" <?php selected($data['align'] ?? 'center', 'right'); ?>><?php _e('Right', 'theme-styles'); ?></option>
                    <option value="justify" <?php selected($data['align'] ?? 'center', 'justify'); ?>><?php _e('Justify', 'theme-styles'); ?></option>
                </select>
            </div>
            <div>
    ...
    <div class="ts-section">
        <h3 class="ts-section-title"><?php _e('Page Numbers', 'theme-styles'); ?></h3>
        ...
        <div class="ts-states-grid">
                ...
                <div class="ts-state-box">
                    ...
                    <div class="ts-state-box-body">
                        ...
                        <div class="ts-state-field">
                            <label class="ts-field-label"><?php _e('Text', 'theme-styles'); ?></label>
    ...
    <div class="ts-section">
        <h3 class="ts-section-title"><?php _e('Prev/Next Buttons', 'theme-styles'); ?></h3>
        ...
        <div class="ts-states-grid">
                ...
                <div class="ts-state-box">
                    <div class="ts-state-box-header">
                        <h5 class="ts-state-box-title"><?php _e('Disabled', 'theme-styles'); ?></h5>
                    </div>
                    <div class="ts-state-box-body">
                        <div class="ts-state-field">
                            <label class="ts-field-label"><?php _e('Text', 'theme-styles'); ?></label>
        ...
        <div style="margin-top: 30px;">
            <div class="ts-field-row ts-field-row-3">
                <div>
                    <label class="ts-field-label"><?php _e('Prev Icon', 'theme-styles'); ?></label>
                ...
                <div>
                    <label class="ts-field-label"><?php _e('Next Icon', 'theme-styles'); ?></label>
