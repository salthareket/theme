...
<div class="ts-module-typography">
    ...
    <div class="ts-module-tab-content active" data-module-tab-content="edit">
        ...
        <div class="ts-section">
            <h3 class="ts-section-title"><?php _e('Font Families', 'theme-styles'); ?></h3>
            <div class="ts-field-row ts-field-row-3">
                <div><?php theme_styles_render_font_family_field('font_primary', $data['font_primary'] ?? '', ['label' => __('Primary (Body)', 'theme-styles')]); ?></div>
                <div><?php theme_styles_render_font_family_field('font_heading', $data['font_heading'] ?? '', ['label' => __('Heading', 'theme-styles')]); ?></div>
                <div><?php theme_styles_render_font_family_field('font_secondary', $data['font_secondary'] ?? '', ['label' => __('Secondary', 'theme-styles')]); ?></div>
            </div>
            <div class="ts-field-row ts-field-row-2" style="margin-top: 20px;">
                <div><?php theme_styles_render_font_family_field('icon_font', $data['icon_font'] ?? '', ['label' => __('Icon Font', 'theme-styles')]); ?></div>
                <div><?php theme_styles_render_font_family_field('icon_font_brands', $data['icon_font_brands'] ?? '', ['label' => __('Icon Font (Brands)', 'theme-styles')]); ?></div>
            </div>
        </div>

        <!-- Base Settings -->
        <div class="ts-section">
            <h3 class="ts-section-title"><?php _e('Base Settings', 'theme-styles'); ?></h3>
            <div class="ts-field-row ts-field-row-4">
                ...
                <div>
                    <label class="ts-field-label"><?php _e('Line Height', 'theme-styles'); ?></label>
        ...
        <!-- Headings -->
        <div class="ts-section">
            <h3 class="ts-section-title"><?php _e('Headings', 'theme-styles'); ?></h3>
            <div class="ts-headings-grid">
                ...
                <div class="ts-heading-column">
                    ...
                    <div class="ts-heading-fields">
                        <div>
                            <?php theme_styles_render_font_family_field("headings.{$h}.font_family", $hd['font_family'] ?? '', ['label' => __('Font', 'theme-styles')]); ?>
                        </div>
                        <div>
                            <label class="ts-field-label-sm"><?php _e('Size', 'theme-styles'); ?></label>
                        ...
                        <div>
                            <label class="ts-field-label-sm"><?php _e('Weight', 'theme-styles'); ?></label>
                        ...
                        <div>
                            <label class="ts-field-label-sm"><?php _e('Line Height', 'theme-styles'); ?></label>
                        ...
                        <div>
                            <label class="ts-field-label-sm"><?php _e('Transform', 'theme-styles'); ?></label>
        ...
        <!-- Responsive Sizes -->
        <div class="ts-section">
            <h3 class="ts-section-title"><?php _e('Responsive Sizes', 'theme-styles'); ?></h3>
            <p class="ts-section-description" style="margin-bottom:24px;"><?php _e('Min (mobile) → Max (desktop) arasında otomatik fluid clamp üretilir.', 'theme-styles'); ?></p>
            ...
            <div class="ts-fluid-sizes-row">
                ...
                <div class="ts-fluid-type-block">
                    <div class="ts-fluid-type-header">
                        <h4 class="ts-fluid-type-title"><?php _e('Title Sizes', 'theme-styles'); ?></h4>
                        <span class="ts-fluid-type-preview" id="ts-fluid-title-preview">clamp(…)</span>
                    </div>

                    <div class="ts-fluid-group-label"><?php _e('Font Size', 'theme-styles'); ?></div>
                    ...
                    <div class="ts-fluid-group-label" style="margin-top:16px;"><?php _e('Line Height', 'theme-styles'); ?></div>
                    <div class="ts-fluid-pair">
                        <div class="ts-fluid-pair-row">
                            <label class="ts-fluid-pair-label">Min</label>
                    ...
                    <button type="button" class="ts-fluid-advanced-toggle" data-target="ts-title-advanced">
                        ...
                        <?php _e('Per-breakpoint override', 'theme-styles'); ?>
                    </button>
                    <div class="ts-fluid-advanced-panel" id="ts-title-advanced" style="display:none;">
                        <p class="ts-fluid-advanced-note"><?php _e('Doldurduğun breakpoint\'ler clamp yerine direkt değer olarak kullanılır.', 'theme-styles'); ?></p>
                ...
                <div class="ts-fluid-type-block">
                    <div class="ts-fluid-type-header">
                        <h4 class="ts-fluid-type-title"><?php _e('Text Sizes', 'theme-styles'); ?></h4>
            ...
            <div class="ts-fluid-type-block" style="margin-top:16px;">
                <div class="ts-fluid-type-header">
                    <h4 class="ts-fluid-type-title">
                        ...
                        <?php _e('Mobile Overrides', 'theme-styles'); ?>
                    </h4>
                ...
                <div id="ts-mobile-override-panel" <?php echo empty($data['mobile_override_active']) ? 'style="display:none;"' : ''; ?>>
                    <p class="ts-fluid-advanced-note" style="margin:12px 0;"><?php _e('xs breakpoint\'te fluid clamp yerine bu değerler kullanılır.', 'theme-styles'); ?></p>
