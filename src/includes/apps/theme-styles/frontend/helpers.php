 ...
 * @return array
 */
function theme_styles_get_data() {
 ...
 * @return array|null
 */
function theme_styles_get_module($module_name) {
    $data = theme_styles_get_data();
 ...
 * @return mixed
 */
function theme_styles_get_var($var_name, $default = '') {
    $data = theme_styles_get_data();
...
function theme_styles_load_modules($modules = [], $post_id = null) {
    ...
    foreach ($modules as $module) {
        $processor_file = THEME_STYLES_PATH . "/modules/{$module}/processor.php";
