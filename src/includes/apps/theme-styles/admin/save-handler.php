...
// Save theme styles
add_action('wp_ajax_theme_styles_save', 'theme_styles_save_ajax');
function theme_styles_save_ajax() {
    check_ajax_referer('theme_styles_nonce', 'nonce');
    ...
    $instance = Theme_Styles::init();
    $result = $instance->save_data($data, get_option('theme_styles_active_preset', ''));
...
// Save preset
add_action('wp_ajax_theme_styles_save_preset', 'theme_styles_save_preset_ajax');
function theme_styles_save_preset_ajax() {
    check_ajax_referer('theme_styles_nonce', 'nonce');
...
// Load preset
add_action('wp_ajax_theme_styles_load_preset', 'theme_styles_load_preset_ajax');
function theme_styles_load_preset_ajax() {
    check_ajax_referer('theme_styles_nonce', 'nonce');
...
// Delete preset
add_action('wp_ajax_theme_styles_delete_preset', 'theme_styles_delete_preset_ajax');
function theme_styles_delete_preset_ajax() {
    check_ajax_referer('theme_styles_nonce', 'nonce');
...
// Duplicate preset
add_action('wp_ajax_theme_styles_duplicate_preset', 'theme_styles_duplicate_preset_ajax');
function theme_styles_duplicate_preset_ajax() {
    check_ajax_referer('theme_styles_nonce', 'nonce');
...
// Rename preset
add_action('wp_ajax_theme_styles_rename_preset', 'theme_styles_rename_preset_ajax');
function theme_styles_rename_preset_ajax() {
    check_ajax_referer('theme_styles_nonce', 'nonce');
    if (!current_user_can('manage_options')) wp_send_json_error(['message' => 'Unauthorized']);
    ...
    if ($result) {
        ...
        if (get_option('theme_styles_active_preset') === $name) {
            update_option('theme_styles_active_preset', $new_name);
        }
...
// Export preset
add_action('admin_post_theme_styles_export_preset', 'theme_styles_export_preset');
function theme_styles_export_preset() {
    if (!current_user_can('manage_options')) {
        wp_die('Unauthorized');
    }
...
// Import preset
add_action('wp_ajax_theme_styles_import_preset', 'theme_styles_import_preset_ajax');
function theme_styles_import_preset_ajax() {
    check_ajax_referer('theme_styles_nonce', 'nonce');
...
// Revert to default
add_action('wp_ajax_theme_styles_revert', 'theme_styles_revert_ajax');
function theme_styles_revert_ajax() {
    check_ajax_referer('theme_styles_nonce', 'nonce');
...
add_action('wp_ajax_theme_styles_generate_preview', 'theme_styles_generate_preview_ajax');
function theme_styles_generate_preview_ajax() {
    check_ajax_referer('theme_styles_nonce', 'nonce');
