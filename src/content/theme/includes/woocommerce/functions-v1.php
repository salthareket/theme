...
//
// BÖLÜMLER:
//   1. TIMBER / PRODUCT BRIDGE   — Timber entegrasyonu
//   2. TEASE / LOOP              — Ürün kartı (tease.twig) için
//   3. FİYAT                     — Fiyat hesaplama ve HTML
//   4. STOK / ROZET              — Stok durumu, ürün rozetleri
//   5. GÖRSEL                    — Ürün görselleri
//   6. VARİASYON                 — Varyasyon yardımcıları
//   7. SEPETİ                    — Sepet işlemleri
//   8. URL / SAYFA               — WooCommerce URL'leri
//   9. PARA BİRİMİ               — Para birimi formatları
//  10. YORUM / RATING            — Yorum ve puan sistemi
//  11. LAYOUT                    — Arşiv grid düzeni
//  12. ROLE BASED PRICING        — Role göre fiyatlandırma
//  13. ATTRIBUTE                 — Ürün attribute yardımcıları
//  14. BUNDLE                    — Paket ürün fiyatları
//  15. ICONIC / WSSV             — Iconic Show Single Variations
//
// ============================================================


// ============================================================
// 1. TIMBER / PRODUCT BRIDGE
// ============================================================

/** Timber post nesnesinden WooCommerce ürün nesnesi döner (Timber entegrasyonu için) */
...
function variable_product_price($product){
	...
	if ( $sale_price > 0 && $sale_price < $regular_price ) {
		...
		return '<del>' . wc_price( $regular_price ) . '</del> <ins>' . wc_price( $min_price ) . ' – ' . wc_price( $max_price ) . '</ins>';
	}
