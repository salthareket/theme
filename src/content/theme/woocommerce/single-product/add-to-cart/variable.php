...
<form class="variations_form cart" action="<?php echo esc_url( apply_filters( 'woocommerce_add_to_cart_form_action', $product->get_permalink() ) ); ?>" method="post" enctype='multipart/form-data' data-product_id="<?php echo absint( $product->get_id() ); ?>" data-product_variations="<?php echo $variations_attr; // WPCS: XSS ok. ?>">
	...
	<?php else : ?>
		<div class="product-attributes variations">
				...
				<?php foreach ( array_reverse($attributes) as $attribute_name => $options ) : ?>
					<div class="col-<?php echo esc_attr( sanitize_title( $attribute_name ) ); ?>"><!--<tr>-->
						<label class="form-label label title-<?php echo esc_attr( sanitize_title( $attribute_name ) ); ?>" for="<?php echo esc_attr( sanitize_title( $attribute_name ) ); ?>"><?php //echo wc_attribute_label( $attribute_name ); // WPCS: XSS ok. ?></label>
						<div class="value--">
							<?php
